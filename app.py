...
# if st.button("Predict Hotel Rating"):
...
#     # If any fields are missing or have insufficient words, display an error notification
...
#     else:
#         # Create a DataFrame for input (column names must match training)
